...
// NOTE: no `implements PromiseLike<QueryResponse>` here
class SupabaseSelectQuery {
...
// Also no `implements PromiseLike<QueryResponse>` here
...
export function getServiceSupabaseClient(): SupabaseClient {
  if (!cachedServiceClient) cachedServiceClient = new SupabaseRestClient(getSupabaseServiceKey());
  return cachedServiceClient;
}

export function getAnonSupabaseClient(): SupabaseClient {
  if (!cachedAnonClient) cachedAnonClient = new SupabaseRestClient(getSupabaseAnonKey());
