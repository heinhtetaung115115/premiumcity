      ...
      {selected === null && (
        <>
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* ── Crypto (USDT) — coming soon ── */}
            <div
              aria-disabled="true"
              className="flex cursor-not-allowed items-center gap-4 rounded-2xl border border-slate-800 bg-white/[0.02] p-4 text-left opacity-70"
            >
              <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-slate-500/10">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <p className="text-sm font-semibold text-slate-300">USDT (Crypto)</p>
                  <span className="rounded bg-amber-500/15 px-1.5 py-0.5 text-[9px] font-semibold text-amber-300">
                    COMING SOON
                  </span>
                </div>
                <p className="mt-0.5 text-[11px] text-slate-500">Pay with USDT — available shortly</p>
              </div>
            </div>
          </div>
        </>
